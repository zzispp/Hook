...
use super::{Wallet, WalletAdjustmentType, WalletBalanceType, WalletTransaction};
...
#[derive(Clone, Debug, Default, PartialEq, Eq)]
pub struct AdminWalletLedgerFilters {
...
#[derive(Clone, Debug, PartialEq, Serialize)]
pub struct AdminWalletLedgerResponse {
    pub items: Vec<AdminWalletLedgerTransactionResponse>,
    pub total: u64,
    pub page: u64,
    pub page_size: u64,
}
