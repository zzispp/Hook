...
pub struct SystemSettingsResponse {
    ...
    pub auth_solana_enabled: bool,
    pub auth_solana_network: String,
    pub auth_wallet_domain: String,
    pub auth_wallet_statement: String,
...
impl From<SystemSettings> for SystemSettingsResponse {
    fn from(value: SystemSettings) -> Self {
        Self {
            ...
            auth_solana_enabled: value.auth_solana_enabled,
            auth_solana_network: value.auth_solana_network,
            auth_wallet_domain: value.auth_wallet_domain,
            auth_wallet_statement: value.auth_wallet_statement,
