...
fn summary_row(request_count: i64) -> BTreeMap<String, Value> {
    BTreeMap::from([
        ...
        ("p50_first_output_ms".into(), Value::BigInt(None)),
        ("p90_first_output_ms".into(), Value::BigInt(None)),
        ("p95_first_output_ms".into(), Value::BigInt(None)),
        ("p99_first_output_ms".into(), Value::BigInt(None)),
