...
fn summary_row(request_count: i64) -> BTreeMap<String, Value> {
    BTreeMap::from([
        ...
        ("p50_first_byte_ms".into(), Value::BigInt(None)),
        ("p90_first_byte_ms".into(), Value::BigInt(None)),
        ("p95_first_byte_ms".into(), Value::BigInt(None)),
        ("p99_first_byte_ms".into(), Value::BigInt(None)),
        ("p50_response_headers_ms".into(), Value::BigInt(None)),
        ("p90_response_headers_ms".into(), Value::BigInt(None)),
        ("p95_response_headers_ms".into(), Value::BigInt(None)),
        ("p99_response_headers_ms".into(), Value::BigInt(None)),
        ("p50_first_token_ms".into(), Value::BigInt(None)),
        ("p90_first_token_ms".into(), Value::BigInt(None)),
        ("p95_first_token_ms".into(), Value::BigInt(None)),
        ("p99_first_token_ms".into(), Value::BigInt(None)),
