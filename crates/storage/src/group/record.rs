...
pub use crate::provider::record::{billing_group_provider_keys, billing_group_providers};
...
pub type BillingGroupProviderKeyRecord = billing_group_provider_keys::Model;
