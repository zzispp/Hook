...
pub(super) fn candidate_detail(candidate: RequestCandidateRecord) -> StorageResult<RequestCandidateDetail> {
    ...
    Ok(RequestCandidateDetail {
        ...
        input_text_tokens: candidate.input_text_tokens,
        input_audio_tokens: candidate.input_audio_tokens,
        input_image_tokens: candidate.input_image_tokens,
        output_text_tokens: candidate.output_text_tokens,
        output_audio_tokens: candidate.output_audio_tokens,
        output_image_tokens: candidate.output_image_tokens,
        reasoning_tokens: candidate.reasoning_tokens,
        cache_creation_5m_input_tokens: candidate.cache_creation_5m_input_tokens,
        cache_creation_1h_input_tokens: candidate.cache_creation_1h_input_tokens,
