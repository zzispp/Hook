...
use types::{
    model::PatchField,
    provider::{ProviderKeyGroup, ProviderKeyGroupMember},
};

use super::super::{
    ProviderKeyGroupRecordInput, ProviderKeyGroupRecordPatch,
...
fn format_timestamp(value: sea_orm::entity::prelude::TimeDateTimeWithTimeZone) -> String {
    value
        ...
        .expect("provider key group timestamp must format as RFC3339")
}
