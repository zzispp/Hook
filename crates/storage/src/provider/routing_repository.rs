...
pub struct RoutingMetricRecord {
    ...
    pub timing_metric_semantics_version: String,
...
pub struct RoutingRouteStateRecord {
    ...
    pub ema_first_token_ms: Option<f64>,
...
pub struct RoutingMetricDelta {
    ...
    pub first_token_success_count: i64,
    pub first_token_failure_count: i64,
