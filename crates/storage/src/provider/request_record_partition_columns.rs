...
cache_read_price_per_million, cost_currency, token_cost, base_cost, total_cost, billing_multiplier, billing_snapshot, first_byte_time_ms, total_latency_ms, \
candidate_count, created_at, started_at, finished_at, updated_at";
...
base_cost, total_cost, billing_multiplier, billing_snapshot, latency_ms, first_byte_time_ms, error_type, error_message, error_code, error_param, created_at, \
...
r.total_cost, r.billing_multiplier, r.billing_snapshot, r.first_byte_time_ms, r.total_latency_ms, r.candidate_count, NULL::text AS request_headers, \
...
r.upstream_cache_creation_cost, r.upstream_cache_read_cost, r.upstream_total_cost, r.input_cost, r.output_cost, r.cache_creation_cost, r.cache_read_cost, r.request_cost, \
r.input_price_per_million, r.output_price_per_million, r.cache_creation_price_per_million, r.cache_read_price_per_million, r.cost_currency, r.token_cost, r.base_cost, \
r.total_cost, r.billing_multiplier, r.billing_snapshot, r.first_byte_time_ms, r.total_latency_ms, r.candidate_count, r.request_headers, r.request_body, \
...
r.latency_ms, r.first_byte_time_ms, r.error_type, r.error_message, r.error_code, r.error_param, r.created_at, r.started_at, r.finished_at";
...
r.base_cost, r.total_cost, r.billing_multiplier, r.billing_snapshot, r.latency_ms, r.first_byte_time_ms, r.error_type, r.error_message, r.error_code, r.error_param, \
