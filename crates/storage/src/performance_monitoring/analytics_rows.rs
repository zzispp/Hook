...
pub(super) struct PercentileRow {
    ...
    pub p50_first_sse_event_ms: Option<i64>,
    pub p90_first_sse_event_ms: Option<i64>,
    pub p99_first_sse_event_ms: Option<i64>,
    pub p50_first_output_ms: Option<i64>,
    pub p90_first_output_ms: Option<i64>,
    pub p99_first_output_ms: Option<i64>,
    pub p50_sse_to_output_ms: Option<i64>,
    pub p90_sse_to_output_ms: Option<i64>,
    pub p99_sse_to_output_ms: Option<i64>,
}
...
pub(super) struct UpstreamSummaryRow {
    ...
    pub first_sse_event_sample_count: Option<i64>,
    pub first_output_sample_count: Option<i64>,
    pub sse_to_output_sample_count: Option<i64>,
...
impl From<PercentileRow> for PerformancePercentilePoint {
    fn from(row: PercentileRow) -> Self {
        Self {
            ...
            p50_first_sse_event_ms: row.p50_first_sse_event_ms,
            p90_first_sse_event_ms: row.p90_first_sse_event_ms,
            p99_first_sse_event_ms: row.p99_first_sse_event_ms,
            ...
            p50_sse_to_output_ms: row.p50_sse_to_output_ms,
            p90_sse_to_output_ms: row.p90_sse_to_output_ms,
            p99_sse_to_output_ms: row.p99_sse_to_output_ms,
        }
    }
}
...
impl From<UpstreamSummaryRow> for UpstreamPerformanceSummary {
    fn from(row: UpstreamSummaryRow) -> Self {
        ...
        Self {
            ...
            first_sse_event_sample_count: row.first_sse_event_sample_count.unwrap_or_default(),
            first_output_sample_count: row.first_output_sample_count.unwrap_or_default(),
            sse_to_output_sample_count: row.sse_to_output_sample_count.unwrap_or_default(),
...
impl From<UpstreamProviderRow> for UpstreamPerformanceProvider {
    fn from(row: UpstreamProviderRow) -> Self {
        Self {
            ...
            first_sse_event_sample_count: row.first_sse_event_sample_count,
            first_output_sample_count: row.first_output_sample_count,
            sse_to_output_sample_count: row.sse_to_output_sample_count,
