...
pub(super) struct PercentileRow {
    ...
    pub p50_first_byte_ms: Option<i64>,
    pub p90_first_byte_ms: Option<i64>,
    pub p99_first_byte_ms: Option<i64>,
    ...
    pub p90_first_token_ms: Option<i64>,
    pub p99_first_token_ms: Option<i64>,
}
...
pub(super) struct UpstreamSummaryRow {
    ...
    pub first_byte_sample_count: Option<i64>,
    pub response_headers_sample_count: Option<i64>,
    pub first_token_sample_count: Option<i64>,
...
impl From<PercentileRow> for PerformancePercentilePoint {
    fn from(row: PercentileRow) -> Self {
        Self {
            ...
            p50_first_byte_ms: row.p50_first_byte_ms,
            p90_first_byte_ms: row.p90_first_byte_ms,
            p99_first_byte_ms: row.p99_first_byte_ms,
            ...
            p50_first_token_ms: row.p50_first_token_ms,
            p90_first_token_ms: row.p90_first_token_ms,
            p99_first_token_ms: row.p99_first_token_ms,
        }
    }
}
...
impl From<UpstreamSummaryRow> for UpstreamPerformanceSummary {
    fn from(row: UpstreamSummaryRow) -> Self {
        ...
        Self {
            ...
            first_byte_sample_count: row.first_byte_sample_count.unwrap_or_default(),
            response_headers_sample_count: row.response_headers_sample_count.unwrap_or_default(),
            first_token_sample_count: row.first_token_sample_count.unwrap_or_default(),
