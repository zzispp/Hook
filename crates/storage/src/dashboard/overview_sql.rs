...
pub(super) fn summary_sql() -> &'static str {
    "SELECT \
        ...
        COALESCE(SUM(b.first_byte_total_ms), 0)::double precision / NULLIF(COALESCE(SUM(b.first_byte_sample_count), 0), 0)::double precision AS avg_first_byte_ms, \
        ...
        COALESCE(SUM(b.first_token_total_ms), 0)::double precision / NULLIF(COALESCE(SUM(b.first_token_sample_count), 0), 0)::double precision AS avg_first_token_ms, \
