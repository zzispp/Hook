    ...
    C: ConnectionTrait,
{
    ...
    let sql = format!(
        ...
        response_headers_ms, first_token_ms, latency_ms, first_byte_ms, updated_at) \
        VALUES ({}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}) \
        ...
        error_category = EXCLUDED.error_category, response_headers_ms = EXCLUDED.response_headers_ms, first_token_ms = EXCLUDED.first_token_ms, \
        latency_ms = EXCLUDED.latency_ms, first_byte_ms = EXCLUDED.first_byte_ms, updated_at = EXCLUDED.updated_at",
        ...
        params.push(record.first_token_time_ms),
