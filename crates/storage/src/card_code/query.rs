...
use types::card_code::{
    CARD_CODE_STATUS_ACTIVE, CARD_CODE_STATUS_EXPIRED, CardCodeListFilters, CardCodeTypeListFilters,
};

use crate::card_code::{card_code_records, card_code_type_records};

pub(super) fn filtered_types(
    filters: CardCodeTypeListFilters,
) -> sea_orm::Select<card_code_type_records::Entity> {
...
pub(super) fn filtered_codes(
    filters: CardCodeListFilters,
) -> sea_orm::Select<card_code_records::Entity> {
...
fn apply_status_filter(
    query: sea_orm::Select<card_code_records::Entity>,
