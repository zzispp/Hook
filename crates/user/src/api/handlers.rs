...
pub use account::{account_identities, account_password_change, account_password_email_code, account_profile, account_unlink_identity};
...
pub use auth::{
    ...
    sign_in, sign_up, wallet_complete, wallet_email_code, wallet_nonce, wallet_sign_in,
};
