...
pub(in crate::application::service) fn reject_closed_registration(settings: &RegistrationSettings) -> AppResult<()> {
...
pub(in crate::application::service) fn reject_disallowed_registration_email(settings: &RegistrationSettings, email: &str) -> AppResult<()> {
