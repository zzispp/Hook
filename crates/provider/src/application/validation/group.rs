...
pub fn sanitize_provider_key_group_list_request(input: ProviderKeyGroupListRequest) -> ProviderKeyGroupListRequest {
    ProviderKeyGroupListRequest {
...
pub fn validate_provider_key_group_list_request(request: &ProviderKeyGroupListRequest) -> ProviderResult<()> {
