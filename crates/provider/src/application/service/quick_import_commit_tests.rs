...
fn provider_create_uses_quick_import_provider_config() {
    let config = ProviderQuickImportProviderConfig {
        ...
        stream_response_headers_timeout_seconds: Some(18.0),
    ...
    assert_eq!(provider.stream_response_headers_timeout_seconds, Some(18.0));
    assert_eq!(provider.stream_first_byte_timeout_seconds, Some(30.0));
    assert_eq!(provider.stream_first_token_timeout_seconds, Some(45.0));
