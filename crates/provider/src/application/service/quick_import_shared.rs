...
const DEFAULT_STREAM_RESPONSE_HEADERS_TIMEOUT_SECONDS: f64 = 12.0;
    ...
    ProviderCreate {
        ...
        stream_response_headers_timeout_seconds: Some(
            config
                ...
                .unwrap_or(DEFAULT_STREAM_RESPONSE_HEADERS_TIMEOUT_SECONDS),
        ),
        ...
        stream_first_token_timeout_seconds: Some(config.stream_first_token_timeout_seconds.unwrap_or(DEFAULT_STREAM_FIRST_TOKEN_TIMEOUT_SECONDS)),
