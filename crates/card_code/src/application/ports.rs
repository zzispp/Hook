...
use types::{
    card_code::{
        ...
        CardCodeRedeemPayload, CardCodeRedeemResponse, CardCodeType, CardCodeTypeCreatePayload,
        CardCodeTypeListFilters, CardCodeTypeUpdatePayload, CardCodeBatchStatusPayload,
        CardCodeBatchStatusResponse, CardCodeGeneratePayload, CardCodeGenerateResponse,
        CardCodeListResponse, CardCodeTypeListResponse,
    },
