...
fn menu_section_record_input(input: types::rbac::MenuSectionInput) -> MenuSectionRecordInput {
...
fn menu_item_record_input(input: types::rbac::MenuItemInput) -> MenuItemRecordInput {
    MenuItemRecordInput {
