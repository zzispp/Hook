...
use crate::api::{
    RechargeApiState,
    handlers::{
        create_package, create_user_order, list_order_summary, list_orders, list_packages, list_payment_channels, list_user_orders, list_user_packages,
        list_user_payment_channels, update_package, update_payment_channel,
    },
    payment_callbacks::{
...
pub fn create_router(state: RechargeApiState) -> Router {
    Router::new()
        ...
        .route("/admin/recharge-orders/summary", get(list_order_summary))
