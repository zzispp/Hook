...
export function GlobalModelFormFields({ form, isEdit, profiles, onChange }: Props) {
  return (
    <Stack sx={{ gap: 2.5, minWidth: 0 }}>
      <BasicFields form={form} isEdit={isEdit} profiles={profiles} onChange={onChange} />
...
function BasicFields({ form, isEdit, profiles, onChange }: Props) {
  ...
  return (
    <Section title={t('models.basic')}>
      ...
      />
      <RoutingProfileSelect form={form} profiles={profiles} onChange={onChange} />
      <SwitchRow
...
function MetadataFields({
  ...
  return (
    <Section title={t('models.metadata')}>
      ...
      />
      <ModalitiesFields form={form} onChange={onChange} />
    </Section>
  );
}

function ModalitiesFields({
  form,
  onChange,
}: {
  form: GlobalModelForm;
