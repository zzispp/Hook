...
export function getResponseBody(
  ...
  if (model === 'deepseek-r1') {
    return t('liveDemo.responses.custom.deepseek', { prompt: promptText, model, siteName });
  }

  return t('liveDemo.responses.custom.default', { prompt: promptText, model, siteName });
}
