...
const LiveDemo = ({ siteName }: LiveDemoProps) => {
  ...
  const handleSend = useCallback(() => {
    ...
    const responseBody = getResponseBody(t, selectedModel, promptText, siteName, presetPrompt);
  ...
  }, [addLog, clearTimers, isRunning, model, presetPrompts, prompt, scheduleTimer, simulateFailure, siteName, t]);
  ...
  return (
    <section id="live-demo" className="ln-demo-section" style={styleOverrides}>
      <div className="ln-demo-inner">
        <h2 className="ln-demo-title">{t('liveDemo.title', { siteName })}</h2>
        ...
        <div className="ln-playground">
          ...
          <div className="ln-playground-terminal">
            <div className="ln-terminal-head">
              ...
              <span className="ln-terminal-title">{t('liveDemo.terminalTitle', { siteName })}</span>
            </div>
