...
.ln-site-status-mark {
  ...
  animation: ln-site-status-spin 0.9s linear infinite;
}

.ln-site-status-title {
  margin: 0;
...
.ln-site-status-action:hover {
  background: rgba(255, 255, 255, 0.14);
}

@keyframes ln-site-status-spin {
  to {
