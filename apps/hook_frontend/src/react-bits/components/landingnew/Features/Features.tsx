      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="ln-feat-aichat-head">
            ...
            <span className="ln-feat-aichat-title">{t('features.monitor.title')}</span>
          </div>
...
const CARD_VISUALS: Record<string, ReactNode> = {
  models: <ModelMarquee />,
  tokens: <TokenFloat />,
  routing: <ProviderOrbit />,
  deployment: <DeployTabs />,
  monitoring: <HealthTerminal />,
  quota: <QuotaStats />,
};
