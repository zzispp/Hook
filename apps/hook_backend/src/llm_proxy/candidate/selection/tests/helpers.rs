...
fn key(id: &str, internal_priority: i32) -> CachedProviderKey {
    ...
    CachedProviderKey {
        ...
        global_priority_by_format: std::collections::BTreeMap::from([
            ("openai:chat".to_owned(), internal_priority),
            ("openai:cli".to_owned(), internal_priority),
            ("gemini:chat".to_owned(), internal_priority),
            ("openai:image".to_owned(), internal_priority),
            ("openai_image".to_owned(), internal_priority),
            ("openai_image_edit".to_owned(), internal_priority),
            ("openai:compact".to_owned(), internal_priority),
        ]),
        rpm_limit: None,
        cache_ttl_minutes: 5,
