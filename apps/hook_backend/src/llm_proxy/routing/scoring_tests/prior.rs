...
fn make_prior(candidate: &mut crate::llm_proxy::routing::RoutingScoreCandidate, sample_count: u64, effective_sample_count: u64) {
    ...
    candidate.effective_sample_count = effective_sample_count;
}
