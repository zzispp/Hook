...
pub(super) fn proxy_candidate(state: &LlmProxyState, parts: FixedParts, stream: bool) -> Result<ProxyCandidate, LlmProxyError> {
    ...
    Ok(ProxyCandidate {
        ...
        price_per_request: parts.model.price_per_request.or(parts.global_model.default_price_per_request),
        tiered_pricing: parts.model.tiered_pricing.unwrap_or(parts.global_model.default_tiered_pricing),
