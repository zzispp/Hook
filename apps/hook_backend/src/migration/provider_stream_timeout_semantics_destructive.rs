...
const DESTRUCTIVE_VERSION: &str = "m20260630_000001_provider_stream_timeout_semantics";
const MIGRATION_TABLE: &str = "seaql_migrations";
const SQL_STATEMENTS: &[&str] = &[
    "ALTER TABLE IF EXISTS providers ADD COLUMN IF NOT EXISTS stream_response_headers_timeout_seconds DOUBLE PRECISION NULL",
    "ALTER TABLE IF EXISTS providers ADD COLUMN IF NOT EXISTS stream_first_token_timeout_seconds DOUBLE PRECISION NULL",
    "UPDATE providers SET stream_response_headers_timeout_seconds = stream_first_byte_timeout_seconds WHERE stream_response_headers_timeout_seconds IS NULL",
    "UPDATE providers SET stream_first_token_timeout_seconds = stream_first_output_timeout_seconds WHERE stream_first_token_timeout_seconds IS NULL AND stream_first_output_timeout_seconds IS NOT NULL",
    "ALTER TABLE IF EXISTS providers DROP COLUMN IF EXISTS stream_first_output_timeout_seconds",
];
