...
pub fn reversed_tables() -> Vec<DynIden> {
    vec![
        ...
        AffiliateCommissions::Table.into_iden(),
        ...
        BillingGroupProviderKeyGroups::Table.into_iden(),
        BillingGroupProviderGroups::Table.into_iden(),
        BillingGroupProviderKeys::Table.into_iden(),
        ...
        ProviderCooldownEvents::Table.into_iden(),
        ProviderCooldowns::Table.into_iden(),
        ProviderKeyGroupKeys::Table.into_iden(),
        ProviderKeyGroups::Table.into_iden(),
        ProviderGroupProviders::Table.into_iden(),
        ProviderGroups::Table.into_iden(),
        ...
        AffiliateRelationChanges::Table.into_iden(),
