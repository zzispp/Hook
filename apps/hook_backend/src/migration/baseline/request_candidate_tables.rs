...
pub(super) fn request_records_table() -> TableCreateStatement {
    Table::create()
        ...
        .col(big_integer_null(RequestRecords::FirstOutputTimeMs))
...
pub(super) fn dashboard_user_usage_buckets_table() -> TableCreateStatement {
    Table::create()
        ...
        .col(big_integer(DashboardUserUsageBuckets::FirstOutputTotalMs))
        .col(big_integer(DashboardUserUsageBuckets::FirstOutputSampleCount))
...
pub(super) fn dashboard_cost_analysis_buckets_table() -> TableCreateStatement {
    Table::create()
        ...
        .col(big_integer(DashboardCostAnalysisBuckets::FirstOutputTotalMs))
        .col(big_integer(DashboardCostAnalysisBuckets::FirstOutputSampleCount))
...
pub(super) fn request_candidates_table() -> TableCreateStatement {
    Table::create()
        ...
        .col(big_integer_null(RequestCandidates::FirstOutputTimeMs))
