...
pub(super) fn system_settings_table() -> TableCreateStatement {
    Table::create()
        ...
        .col(boolean(SystemSettings::AuthSolanaEnabled).default(false))
        .col(string_len(SystemSettings::AuthSolanaNetwork, 255).default("mainnet-beta"))
        .col(string_len(SystemSettings::AuthWalletDomain, 255).default(""))
        .col(string_len(SystemSettings::AuthWalletStatement, 200).default("Sign in to Hook"))
