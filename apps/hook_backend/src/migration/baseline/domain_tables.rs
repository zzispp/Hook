...
fn providers_table() -> TableCreateStatement {
    Table::create()
        ...
        .col(double_null(Providers::StreamResponseHeadersTimeoutSeconds))
        .col(double_null(Providers::StreamFirstByteTimeoutSeconds))
        .col(double_null(Providers::StreamFirstTokenTimeoutSeconds))
...
fn provider_quick_import_sources_table() -> TableCreateStatement {
    ...
    Table::create()
        ...
        .col(text(ProviderQuickImportSources::Email).default(""))
        .col(text(ProviderQuickImportSources::EncryptedPassword).default(""))
        .col(text(ProviderQuickImportSources::EncryptedAuthToken))
        .col(text(ProviderQuickImportSources::EncryptedRefreshToken))
        .col(timestamp_tz_null(ProviderQuickImportSources::TokenExpiresAt))
